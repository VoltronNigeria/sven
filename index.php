...
<html class="no-js" lang="zxx">
    <head>
		...
		<meta name="keywords" content="NEVS, Education, Verification" />
		<meta name="description" content="As Nigeria's academic data grid 
		The Nigeria Education 
		Verification System (NEVS) is a unity platform for 
		Nigerian Educational governing bodies, Government Agencies, the organized 
		Private Sector through the Federal Ministry of Education to securely
		exchange, verify and provide information">
		<meta name='copyright' content='Nigera Education Verification System'>
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		<!-- Title -->
		<title>Nigeria Education Verification System</title>
		<!-- Favicon -->
...
<?php include('helpers/header.php'); ?>
		...
		<section class="home-slider">
			<div class="slider-active">
				<!-- Single Slider -->
				<div class="single-slider overlay" style="background-image:url('images/slider/slider-bga.jpg')">
					<div class="container">
						<div class="row">
				...
				<!--/ End Single Slider -->
				<!-- Single Slider -->
				<div class="single-slider overlay" style="background-image:url('images/slider/slider-bgb.jpg')" data-stellar-background-ratio="0.5">
					<div class="container">
						<div class="row">
				...
				<!--/ End Single Slider -->
				<!-- Single Slider -->
				<div class="single-slider overlay" style="background-image:url('images/slider/slider-bgc.jpg')" data-stellar-background-ratio="0.5">
					<div class="container">
						<div class="row">
							<div class="col-lg-8 offset-lg-4 col-md-8 offset-md-4 col-12">
								<div class="slider-text text-right">
									<h1>Creating Opportunities for <span>Academic</span> Communities </h1>
									<p>Our mission is to empower clients, colleagues, and communities to achieve aspirations while building lasting, caring relationships.</p>
									<div class="button">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-6">
						...
						<div class="single-fact">
							...
							<div class="number"><span class="counter">27</span>+</div>
							<p>Higher Institutions</p>
						</div>
						<!--/ End Single Fact -->
					</div>
					<div class="col-lg-3 col-md-6 col-6">
					...
					<div class="col-lg-3 col-md-6 col-6">
						...
						<div class="single-fact">
							...
							<div class="number"><span class="counter">75</span>+</div>
							<p>Data Acquisition Staff</p>
						</div>
						<!--/ End Single Fact -->
					</div>
					<div class="col-lg-3 col-md-6 col-6">
